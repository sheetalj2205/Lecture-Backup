...
public class SignInAsStudent extends javax.swing.JFrame {
    ...
    public SignInAsStudent() {
        ...
        Criteria crit1 = session.createCriteria(AcceptedRequests.class);
        crit1.add(Restrictions.eq("userId",HomePage.id));
        List<AcceptedRequests> data1 = crit1.list();
    ...
    private void jLabel22MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel22MouseClicked
       ...
       query request = new query(1,fullName,HomePage.id,Subject,Topic,Reason,instructorname,fromDate,toDate);
